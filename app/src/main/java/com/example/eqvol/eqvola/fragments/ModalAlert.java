...
*/
    ...
    public static ModalAlert newInstance(boolean status, String description) {
    ...
    public static ModalAlert newInstance(boolean status, String description, Activity activity) {
        ModalAlert fragment = new ModalAlert();
        fragment.status = status;
        fragment.description = description;
    ...
    public static ModalAlert newInstance(boolean status, String description, Activity activity, String target) {
        ModalAlert fragment = new ModalAlert();
        fragment.status = status;
        fragment.description = description;
        fragment.activity = activity;
