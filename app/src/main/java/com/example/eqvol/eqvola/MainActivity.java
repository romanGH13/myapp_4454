...
import com.example.eqvol.eqvola.Notifications.MyNotificationService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private MyNotificationService myService;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.navigation_withdrawal:
                    fragmentClass = WithdrawalPaymentsFragment.class;
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isMyServiceRunning(MyNotificationService.class)) {
            myService = new MyNotificationService();
    ...
    {
        ModalAlert myDialogFragment = ModalAlert.newInstance(status, description, activity, target);
        FragmentManager manager = getSupportFragmentManager();
        FragmentTransaction transaction = manager.beginTransaction();
