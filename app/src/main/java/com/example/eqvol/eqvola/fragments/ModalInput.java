...
public class ModalInput extends DialogFragment implements DialogInterface.OnDismissListener {
    ...
    public static ModalInput newInstance(String description) {
        ModalInput fragment = new ModalInput();
        fragment.description = description;
        return fragment;
    }

    public static ModalInput newInstance(String description, Activity activity) {
        ModalInput fragment = new ModalInput();
        fragment.description = description;
