...
public class Api extends LoginActivity {
    ...
    private static final String siteUrl = "http://api.atirox.eqvola.info/";//"http://api.eqvola.info/";
    ...
    public static List<PaymentSystem> withdrawalPayments;
    ...
    public static String checkToken(String token)
    {
        ...
        return performPostCall(params, siteUrl+"account/self");
    }
    ...
    public static String getWithdrawalPayments(Map<String, Object> params)
    {
        return performPostCall(params, siteUrl+"payment/setting/get");
    }
    ...
    public static String getPaymentImage(Map<String, Object> params) throws UnsupportedEncodingException {
        Map<String, Object> mapUserId = new HashMap<String, Object>();
        PaymentSystem paymentSystem = null;
        for (Map.Entry<String, Object> entry : params.entrySet()) {
            if (entry.getKey().contentEquals("payment")) {
                paymentSystem = (PaymentSystem)entry.getValue();
                mapUserId.put("payment_setting_id", Integer.toString(paymentSystem.getId()));
            }
        }
        paymentSystem.setAvatar(performGetCall(mapUserId, siteUrl+"payment/setting/image"));
        return Integer.toString(user.getId());
    }
    ...
    public static String requestWithdrawal(Map<String, Object> params){
        return performPostCall(params, siteUrl+"withdrawal/do");
    }
