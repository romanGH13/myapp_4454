...
public class MyNotificationService extends Service {
    ...
    private static final String siteUrl = "http://api.eqvola.info/";
    ...
    public void getCounterFromFile(){
        ...
        try {
            fileInputStream = openFileInput(FilenameForCounter);
    ...
    public void getDataFromFile(){
        ...
        if(fileContent != null) {
            ...
            for(String str: arrayData)
            {
                ...
                if(data[0].contentEquals("token"))
                    token = data[1];
                if(data[0].contentEquals("user_id"))
                    user_id = Integer.parseInt(data[1]);
            }
        }
    }
